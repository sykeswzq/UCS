...
<dict>
  ...
  <array>
    ...
    <string>-c</string>
    <string>echo "tick $(date) uid=$(id -u)" >> /var/mobile/Documents/hb_launchd.log; touch /var/mobile/Documents/hb_launch_triggered; launchctl asuser 501 /var/jb/usr/bin/uiopen com.sykes.ucs.app >> /var/mobile/Documents/hb_launchd.log 2>&1; echo "uiopen rc=$?" >> /var/mobile/Documents/hb_launchd.log</string>
  </array>

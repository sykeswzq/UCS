...
- (void)setupLaunchdDaemon {
    @try {
        ...
        "cat > /var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist <<'EOF'\n"
        ...
        "</plist>\n"
        "EOF\n"
        "chown root:wheel /var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist\n"
        "chmod 644 /var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist\n"
        "launchctl bootout gui/501/com.sykes.ucs.schedule 2>/dev/null\n"
        "launchctl bootstrap gui/501 /var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist\n", scriptPath];
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            pid_t pid; int st;
            ...
            char const *b2[] = {"bootstrap", "gui/501", "/var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist", NULL};
            ...
            NSString *realPath = jb ? [NSString stringWithUTF8String:jb("/var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist")] : @"/var/jb/Library/LaunchAgents/com.sykes.ucs.schedule.plist";
